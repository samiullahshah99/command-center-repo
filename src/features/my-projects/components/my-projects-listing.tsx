...
import { MyProjectsBody } from './my-projects-body';
 ...
 */
export default function MyProjectsListing({
  personId,
  nowIso
}: {
  personId: string;
  ...
  void queryClient.prefetchQuery(myProjectsQueryOptions(personId, nowIso));

  return (
    <HydrationBoundary state={dehydrate(queryClient)}>
      <MyProjectsBody personId={personId} nowIso={nowIso} />
    </HydrationBoundary>
  );
}
